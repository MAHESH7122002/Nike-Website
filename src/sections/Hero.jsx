    ...
    <section id="home" className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className='mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold '>
          ...
          <span className='text-coral-red inline-block mt-3  animate-slidein opacity-0 [--slidein-delay:300ms]'>Nike</span> Shoes
        </h1>
        <p className='text-slate-gray leading-8 font-montserrat mt-6 mb-14 sm:max-w-sm:'>Discover Stylish Nike Arrivals, 
